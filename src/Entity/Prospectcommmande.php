 ...
 * Prospectcommmande
 *
 * @ORM\Table(name="prospectcommmande", indexes={@ORM\Index(name="ProspectCommmande_Agent_FK", columns={"id_agent"}), @ORM\Index(name="ProspectCommmande_Client0_FK", columns={"id_client"})})
 * @ORM\Entity
 */
